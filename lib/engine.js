  ...
  function startServerConnection(socket) {
    socket.on('message', message => {
      ...
      if (message.type === 'notification' && message.payload.method === 'checkOrder') {
        console.log('**********checkingOrder', message.payload.method)
    ...
    function(err, api_order) {
      ...
      if (api_order) {
        ...
        if (api_order.status === 'done' || api_order.status === 'partial') {
          ...
          if (exchangeName) {
            const nameSockenNotification = (api_order.status === 'done') ? 'trades' : 'partial'
            console.log('nameSockenNotification :', nameSockenNotification)
