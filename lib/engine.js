  ...
  function startServerConnection(socket) { 
    socket.on("message", message => {
      ...
      client.notification('responseOrder', [
        {arbitrageId: newOrder.arbitrageId, idOrderExcange: '123',
         fulfill: Boolean(+Date.now()%2), price: newOrder.price, volume: newOrder.volume, pair: newOrder.pair,
         typeOrder: newOrder.typeOrder},
        URL_BOT_SERVER,
        serverPort
      ]);
    });
